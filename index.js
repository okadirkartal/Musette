...
musette
    ...
    .action(async() => {
        ...
        try {
            ...
            if(error) {
                switch(error.status){
                    case 401 : console.log(chalk.red("Couldn\t log you in.Please provide correct credentials or token")); break;
                    case 422 : console.log(chalk.red("There already exists a remote repository with the same name")); break;
